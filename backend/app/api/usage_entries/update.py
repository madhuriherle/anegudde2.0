...
def update_consumption_entry(consumption_id: int, payload: ConsumptionEntryUpdate, db: Session = Depends(get_db), current_user: User = Depends(PermissionChecker("consumptions.write"))):
