...
class TokenDetail(Base):
    ...
    printed_offline = Column(Boolean, nullable=False, default=False, server_default="false")
    offline_local_receipt_no = Column(String(50), nullable=True)
    offline_printed_at = Column(DateTime, nullable=True)
