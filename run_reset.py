...
print("--- Uploading reset_prices_stock.py ---")
sftp.put(os.path.join(local_base, "reset_prices_stock.py"), f"{remote_base}/reset_prices_stock.py")

print("--- Running reset script ---")
run_command(ssh, f"cd {remote_base} && backend/.venv/bin/python reset_prices_stock.py")
